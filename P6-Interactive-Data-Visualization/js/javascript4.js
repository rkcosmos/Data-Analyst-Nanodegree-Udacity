	...
	// quantize data range to translate information into color scale
            ...
            map.attr("class", function(d) { 
                if (d.properties.CHA_NE === "Bangkok" || d.properties.CHA_NE === "Yala") {
                    return quantize(fin_data[content][d.properties.CHA_NE][year]) + " special_mark";
                } else { 
                    return quantize(fin_data[content][d.properties.CHA_NE][year]);
                } 
            })
